...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        width = 40
        height = 60
        self.image = pygame.image.load("img/Walk 1.png").convert()
        '''
...
class Platform(pygame.sprite.Sprite):
    ...
    def __init__(self, width, height):
        ...
        pygame.sprite.Sprite.__init__(self)
        self.image = pygame.image.load("img/Floating Platform.png").convert()
...
def main():
    ...
    pygame.mixer.music.load('audio/endlvlsound.mp3')
