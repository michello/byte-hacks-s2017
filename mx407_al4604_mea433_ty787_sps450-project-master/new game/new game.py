...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.image = pygame.image.load("marshmallow new.png").convert()
        #self.image.fill(red)
...
class Level(object):
    ...
    def __init__(self, player):
        ...
        level = [[random.randint(150,250), random.randint(50,75), 200, 550],
                 ...
                 [random.randint(100,225), random.randint(50,75), 2325, 350],
                 [random.randint(100,225), random.randint(50,75), 2625, 400],
                 [random.randint(100,225), random.randint(50,75), 2825, 500],
                 [random.randint(100,225), random.randint(50,75), 3225, 470],
                 [random.randint(100,225), random.randint(50,75), 5200, 100],
                 [random.randint(100,225), random.randint(50,75), 5400, 200],
                 [random.randint(100,225), random.randint(50,75), 5600, 300],
                 [random.randint(100,225), random.randint(50,75), 5800, 400],
                 [random.randint(100,225), random.randint(50,75), 5900, 500],
                 [random.randint(100,225), random.randint(50,75), 6100, 420],
                 [random.randint(100,225), random.randint(50,75), 6300, 500],
                 ]
        ...
        block.rect.y = random.randint(250,300)
        ...
        block2.rect.x = randNum
        block2.rect.y = random.randint(150,280)
        block2.boundary_top = 200
        block2.boundary_bottom = 500
        block2.change_y = -5
        block2.player = self.player
        block2.level = self
        self.platform_list.add(block1)

        # new blocks up and down
        block2 = MovingPlatform(70, 70)
        block2.rect.x = random.randint(3300,3400)
        block2.rect.y = random.randint(150,280)
        block2.boundary_top = 100
        block2.boundary_bottom = 700
        block2.change_y = -5
        block2.player = self.player
        block2.level = self
        self.platform_list.add(block2)

        block3 = MovingPlatform(70, 70)
        block3.rect.x = random.randint(3500,3600)
        block3.rect.y = random.randint(150,280)
        block3.boundary_top = 100
        block3.boundary_bottom = 700
        block3.change_y = -5
        block3.player = self.player
        block3.level = self
        self.platform_list.add(block3)

        block4 = MovingPlatform(70, 70)
        block4.rect.x = random.randint(3700,3800)
        block4.rect.y = random.randint(150,280)
        block4.boundary_top = 100
        block4.boundary_bottom = 700
        block4.change_y = -5
        ...
        block4 = MovingPlatform(70, 70)
        block4.rect.x = random.randint(3900,4000)
        block4.rect.y = random.randint(150,280)
        block4.boundary_top = 100
        block4.boundary_bottom = 700
        block4.change_y = -5
        ...
        block4 = MovingPlatform(70, 70)
        block4.rect.x = random.randint(4100,4200)
        block4.rect.y = random.randint(150,280)
        block4.boundary_top = 100
        block4.boundary_bottom = 700
        block4.change_y = -5
        ...
        block4 = MovingPlatform(70, 70)
        block4.rect.x = random.randint(4400,4500)
        block4.rect.y = random.randint(150,280)
        block4.boundary_top = 100
        block4.boundary_bottom = 700
        block4.change_y = -5
        ...
        block4 = MovingPlatform(70, 70)
        block4.rect.x = random.randint(4600,4700)
        block4.rect.y = random.randint(150,280)
        block4.boundary_top = 100
        block4.boundary_bottom = 700
        block4.change_y = -5
        ...
        block4 = MovingPlatform(70, 70)
        block4.rect.x = random.randint(4800,5000)
        block4.rect.y = random.randint(150,280)
        block4.boundary_top = 100
        block4.boundary_bottom = 700
        block4.change_y = -5
...
def main():
    ...
    if randNum == 1:
        pygame.mixer.music.load('maplestory.mp3')
        pygame.mixer.music.set_endevent(pygame.constants.USEREVENT)
        pygame.mixer.music.play()
    elif randNum == 2:
        pygame.mixer.music.load('dies irae.mp3')
        pygame.mixer.music.set_endevent(pygame.constants.USEREVENT)
        pygame.mixer.music.play()
    elif randNum == 3:
    ...
    pygame.display.set_caption("Wario Party")
    ...
    while not done:
        ...
        #If the player gets to the end of the level, end game.
